<?php
   /* 
    Plugin Name: Teste de plugin (felca 1.0)
    Plugin URI:None
    Author URI:None
    Description: Plugin que cria sliders responsivos(com interacao no painel do admin)
    Author:Wagner .P
    Version:1.0
    */
...
function rts_responsive_thumbnail_slider_remove_access_capabilities(){
   ...
   function install_responsive_thumbnailSlider(){
    ...
    function add_responsive_thumbnail_slider_admin_menu(){
        ...
        $hook_suffix_r_t_s=add_menu_page( __( 'Slider teste','wp-responsive-thumbnail-slider'), __( 'Slider teste','wp-responsive-thumbnail-slider' ), 'rts_responsive_thumbnail_slider_settings', 'responsive_thumbnail_slider', 'responsive_thumbnail_slider_admin_options' );
        $hook_suffix_r_t_s=add_submenu_page( 'responsive_thumbnail_slider', __( 'Slider Setting','wp-responsive-thumbnail-slider'), __( 'Configuracao dos sliders','wp-responsive-thumbnail-slider' ),'rts_responsive_thumbnail_slider_settings', 'responsive_thumbnail_slider', 'responsive_thumbnail_slider_admin_options' );
        $hook_suffix_r_t_s_1=add_submenu_page( 'responsive_thumbnail_slider', __( 'gerenciar imagens','wp-responsive-thumbnail-slider'), __( 'gerenciados de sliders','wp-responsive-thumbnail-slider'),'rts_responsive_thumbnail_slider_view_images', 'responsive_thumbnail_slider_image_management', 'responsive_thumbnail_image_management' );
        $hook_suffix_r_t_s_2=add_submenu_page( 'responsive_thumbnail_slider', __( 'preview dos sliders','wp-responsive-thumbnail-slider'), __( 'preview dos sliders','wp-responsive-thumbnail-slider'),'rts_responsive_thumbnail_slider_preview', 'responsive_thumbnail_slider_preview', 'responsivepreviewSliderAdmin' );
   ...
   <div id="post-body" class="metabox-holder columns-2" >  
      <div id="post-body-content">
          <div class="wrap">
              ...
              ?>      
              <h1><?php echo __( 'Configuracao do slider','wp-responsive-thumbnail-slider');?></h1>
              <div id="poststuff">
                  <div id="post-body" class="metabox-holder columns-2">
                      <div id="post-body-content">
                          <form method="post" action="" id="scrollersettiings" name="scrollersettiings" >
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label><?php echo __( 'Rolagem automatica? ','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                                                  <?php $settings['auto']=(int)$settings['auto'];?>
                                                  <input style="width:20px;" type='radio' <?php if($settings['auto']==1){echo "checked='checked'";}?>  name='isauto' value='auto' ><?php echo __( 'Automatico','wp-responsive-thumbnail-slider');?> &nbsp;<input style="width:20px;" type='radio' name='isauto' <?php if($settings['auto']==0){echo "checked='checked'";} ?> value='manuall' ><?php echo __( 'Rolar pela seta para a esquerda e para a direita','wp-responsive-thumbnail-slider');?> &nbsp; &nbsp;<input style="width:20px;" type='radio' name='isauto' <?php if($settings['auto']==2){echo "checked='checked'";} ?> value='both' ><?php echo __( 'Rolagem automática com seta','wp-responsive-thumbnail-slider');?>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label ><?php echo __( 'Velocidade','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label ><?php echo __( 'Pausa','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                                      ...
                                      <div style="clear:both"><?php echo __( 'A quantidade de tempo (em ms) entre cada transição automática','wp-responsive-thumbnail-slider');?></div>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label><?php echo __( 'Cor do backgound do slider','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label><?php echo __( 'Maximo visivel','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                                                  <input type="text" id="visible" size="30" name="visible" value="<?php echo $settings['visible']; ?>" style="width:100px;">
                                                  <div style="clear:both"><?php echo __( 'Isso decidirá a largura do seu controle deslizante automaticamente','wp-responsive-thumbnail-slider');?></div>
                                                  <div></div>
                                              </td>
                                          </tr>
                                      </table>
                                      <?php echo __( 'Especifique o número de itens visíveis o tempo todo no controle deslizante.','wp-responsive-thumbnail-slider');?>
                                      <div style="clear:both"></div>

                                  </div>
                              </div>
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                 <h3><label><?php echo __( 'minimo visivel','wp-responsive-thumbnail-slider');?></label></h3>
                                <div class="inside">
                                     <table>
                                       <tr>
                                         <td>
                                           <input type="text" id="min_visible" size="30" name="min_visible" value="<?php echo $settings['min_visible']; ?>" style="width:100px;">
                                           <div style="clear:both"><?php echo __( 'Isso decidirá a largura do controle deslizante no layout responsivo','wp-responsive-thumbnail-slider');?></div>
                                           <div></div>
                                         </td>
                                       </tr>
                                     </table>
                                     <?php echo __( 'O layout responsivo decide pelo próprio controle deslizante usando o mínimo visível.','wp-responsive-thumbnail-slider');?>
                                     <div style="clear:both"></div>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  ...
                                  <div class="inside">
                                      ...
                                      <?php echo __( 'Você pode especificar o número de itens a serem rolados ao clicar nos botões próximo ou anterior.','wp-responsive-thumbnail-slider');?>
                                      <div style="clear:both"></div>
                                  </div>
                              </div>
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label><?php echo __( 'Pausar ao passar o mouse?','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                                                  <input type="checkbox" id="pauseonmouseover" size="30" name="pauseonmouseover" value="" <?php if($settings['pauseonmouseover']==true){echo "checked='checked'";} ?> style="width:20px;">&nbsp;<?php echo __( 'Pausar ao passar o mouse ?','wp-responsive-thumbnail-slider');?> 
                                                  <div style="clear:both"></div>
                                                  <div></div>
                                              </td>
                                          </tr>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label><?php echo __( 'Altura da imagem','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label><?php echo __( 'Largura da imagem','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                  <h3><label><?php echo __( 'Margem da imagem','wp-responsive-thumbnail-slider');?></label></h3>
                                  <div class="inside">
                                      <table>
                                          <tr>
                                              <td>
                                                  <input type="text" id="imageMargin" size="30" name="imageMargin" value="<?php echo $settings['imageMargin']; ?>" style="width:100px;">
                                                  <div style="clear:both;padding-top:5px"><?php echo __( 'intervalo entre as duas imagens','wp-responsive-thumbnail-slider');?></div>
                                                  <div></div>
                                              </td>
                                          </tr>
                                      </table>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                <h3><label><?php echo __( 'mostrar legenda ?','wp-responsive-thumbnail-slider');?></label></h3>
                               <div class="inside">
                                    <table>
                                      <tr>
                                        <td>
                              ...
                              <div class="stuffbox" id="namediv" style="width:100%;">
                                <h3><label><?php echo __( 'mostrar pager ?','wp-responsive-thumbnail-slider');?></label></h3>
                               <div class="inside">
                                    <table>
                                      <tr>
                                        <td>
                              ...
                              <input type="submit"  name="btnsave" id="btnsave" value="<?php echo __( 'salvar configuracoes','wp-responsive-thumbnail-slider');?>" class="button-primary">&nbsp;&nbsp;<input type="button" name="cancle" id="cancle" value="<?php echo __( 'Cancelar','wp-responsive-thumbnail-slider');?>" class="button-primary" onclick="location.href='admin.php?page=responsive_thumbnail_slider_image_management'">
   ...
   ?> 
          ...
          <div id="poststuff"  class="wrap">
              <div id="post-body" class="metabox-holder columns-2">
                  ...
                  <div id="post-body-content" >  
                      <h1><?php echo __( 'Imagens','wp-responsive-thumbnail-slider');?> 
                          <a class="button add-new-h2" href="admin.php?page=responsive_thumbnail_slider_image_management&action=addedit"><?php echo __( 'Adicionar novo','wp-responsive-thumbnail-slider');?></a> 
                       &nbsp;&nbsp;
                       <a class="massAdd button add-new-h2" href="javascript:void(0)"><?php echo __('adicionar massa','wp-responsive-thumbnail-slider');?></a>
                      </h1>
                      <br/>
                      <br/>
                      <form method="POST" action="admin.php?page=responsive_thumbnail_slider_image_management&action=deleteselected"  id="posts-filter" onkeypress="return event.keyCode != 13;">
                          <div class="alignleft actions">
                              <select name="action_upper">
                                  <option selected="selected" value="-1"><?php echo __( 'ações em massa','wp-responsive-thumbnail-slider');?></option>
                                  <option value="delete"><?php echo __( 'Delete','wp-responsive-thumbnail-slider');?></option>
                              </select>
                              <input type="submit" value="<?php echo __( 'Aplicar','wp-responsive-thumbnail-slider');?>" class="button-secondary action" id="deleteselected" name="deleteselected">
                          </div>
                          <br class="clear">
                           <?php
                          ...
                          <?php if($rowCount<$visibleImages){ ?>
                              <h4 style="color: green"><?php echo __( 'Configuração atual do controle deslizante - Total de imagens visíveis ','wp-responsive-thumbnail-slider');?><?php echo $visibleImages; ?></h4>
                              <h4 style="color: green"><?php echo __( 'Por favor, adicione pelo menos','wp-responsive-thumbnail-slider');?><?php echo $visibleImages; ?> <?php echo __( ' images','wp-responsive-thumbnail-slider');?></h4>
                              <?php 
                          ...
                          <div style="padding-top:5px;padding-bottom:5px">
                                <b><?php echo __( 'Procurar','wp-responsive-thumbnail-slider');?> : </b>
                                  <input type="text" value="<?php echo $seval;?>" id="search_term" name="search_term">&nbsp;
                                  <input type='button'  value='<?php echo __( 'Pesquisa','wp-responsive-thumbnail-slider');?>' name='searchusrsubmit' class='button-primary' id='searchusrsubmit' onclick="SearchredirectTO();" >&nbsp;
                                  <input type='button'  value='<?php echo __( 'Redefinir pesquisa','wp-responsive-thumbnail-slider');?>' name='searchreset' class='button-primary' id='searchreset' onclick="ResetSearch();" >
                            </div>  
                            <script type="text/javascript" >
                          ...
                          <table cellspacing="0" id="gridTbl" class="table-bordered table-striped table-condensed cf" >
                              <thead>
                                  ...
                                  <?php if($order_by=="title" and $order_pos=="asc"):?>
                                        <th><a href="<?php echo $setacrionpage;?>&order_by=title&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Titulo','wp-responsive-thumbnail-slider');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                                   <?php else:?>
                                   ...
                                   <th><a href="<?php echo $setacrionpage;?>&order_by=title&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Title','wp-responsive-thumbnail-slider');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                                       <?php else:?>
                                           <th><a href="<?php echo $setacrionpage;?>&order_by=title&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Titulo','wp-responsive-thumbnail-slider');?></a></th>
                                       <?php endif;?>    
                                   <?php endif;?>  
                                   <th><span></span></th>
                                  <?php if($order_by=="createdon" and $order_pos=="asc"):?>
                                    <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Publicado em','wp-responsive-thumbnail-slider');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                                    <?php else:?>
                                        <?php if($order_by=="createdon"):?>
                                    <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Publicado em','wp-responsive-thumbnail-slider');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                                        <?php else:?>
                                            <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Publicado em','wp-responsive-thumbnail-slider');?></a></th>
                                        <?php endif;?>    
                                    <?php endif;?> 
                                  <th><span><?php echo __( 'Editar','wp-responsive-thumbnail-slider');?></span></th>
                                  <th><span><?php echo __( 'Deletar','wp-responsive-thumbnail-slider');?></span></th>
                                  </tr>
                              </thead>
                              ...
                              <tbody id="the-list">
                                  <?php
                                      ...
                                      if($rowsCount > 0){
                                          ...
                                          ?>
                                          <tr valign="top" >
                                              <td class="alignCenter check-column"   data-title="<?php echo __( 'Selecionar registro','wp-responsive-thumbnail-slider');?>" ><input type="checkbox" value="<?php echo $row['id'] ?>" name="thumbnails[]"></td>
                                              <td   data-title="<?php echo __( 'Titulo','wp-responsive-thumbnail-slider');?>" ><strong><?php echo $row['title']; ?></strong></td>  
                                              <td  data-title="<?php echo __( 'Imagem','wp-responsive-thumbnail-slider');?>" class="alignCenter">
                                              <img src="<?php echo $outputimgmain;?>" style="width:50px" height="50px"/>
                                          </td> 
                                              <td class="alignCenter"   data-title="<?php echo __( 'Publicado em','wp-responsive-thumbnail-slider');?>" ><?php echo $row['createdon'] ?></td>
                                              <td class="alignCenter"   data-title="<?php echo __( 'Editar registro','wp-responsive-thumbnail-slider');?>" ><strong><a href='<?php echo $editlink; ?>' title="<?php echo __( 'Edit','wp-responsive-thumbnail-slider');?>"><?php echo __( 'Edit','wp-responsive-thumbnail-slider');?></a></strong></td>  
                                              <td class="alignCenter"   data-title="<?php echo __( 'Apagar registro','wp-responsive-thumbnail-slider');?>" ><strong><a href='<?php echo $deletelink; ?>' onclick="return confirmDelete();"  title="<?php echo __( 'Delete','wp-responsive-thumbnail-slider');?>"><?php echo __( 'Delete','wp-responsive-thumbnail-slider');?></a> </strong></td>  
                                          </tr>
                                          <?php 
                                          } 
                                      }
                                      ...
                                      ?>
                                         ...
                                         <tr valign="top" class="" id="">
                                           <td colspan="6" data-title="<?php echo __( 'No Record','wp-responsive-thumbnail-slider');?>" align="center><strong><?php echo __( 'Nenhuma imagem achada','wp-responsive-thumbnail-slider');?></strong></td>  
                                         </tr>
                          ...
                          <div class="alignleft actions">
                              <select name="action">
                                  <option selected="selected" value="-1"><?php echo __( 'Ações em massa','wp-responsive-thumbnail-slider');?></option>
                                  <option value="delete"><?php echo __( 'Deletar','wp-responsive-thumbnail-slider');?></option>
                              </select>
                      ...
                      <h3><?php echo __( 'Para imprimir este controle deslizante no WordPress Post/Page, use abaixo Shortcode','wp-responsive-thumbnail-slider');?></h3>
                      <input type="text" value="[print_responsive_thumbnail_slider]" style="width: 400px;height: 30px" onclick="this.focus();this.select()" />
                      <div class="clear"></div>
                      <h3><?php echo __( 'Para imprimir este controle deslizante em arquivos PHP de tema/modelo do WordPress, use o código php abaixo','wp-responsive-thumbnail-slider');?></h3>
  ...
  <style type='text/css' >
   ...
   <div style="">  
        <div style="float:left;">
            <div class="wrap">
                    <h1><?php echo __( 'Preview dos sliders adicionados','wp-responsive-thumbnail-slider');?></h1>
            <br>
            <?php
                $wpcurrentdir=dirname(__FILE__);
                $wpcurrentdir=str_replace("\\","/",$wpcurrentdir);
...
<h3><?php echo __( 'Para imprimir este controle deslizante no WordPress Post/Page, use abaixo Shortcode','wp-responsive-thumbnail-slider');?></h3>
<input type="text" value="[imprimir controle deslizante de miniatura responsivo]" style="width: 400px;height: 30px" onclick="this.focus();this.select()" />
<div class="clear"></div>
<h3><?php echo __( 'Para imprimir este controle deslizante em arquivos PHP de tema/modelo do WordPress, use o código php abaixo','wp-responsive-thumbnail-slider');?></h3>
<input type="text" value="echo do_shortcode('[print_responsive_thumbnail_slider]');" style="width: 400px;height: 30px" onclick="this.focus();this.select()" />
<div class="clear"></div>
